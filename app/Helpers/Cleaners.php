    ...
    public static function generateLabelText($abbreviation, $set = 'default')
    {
        $sets = [
            'default' => [
                ...
                // Table name labels
                'vendor_normalized' => 'Company name',
                'gen_vendor_normalized' => 'Company name',
                'sum_effective_value' => 'Total effective value (2010 to 2019)',
                ...
                'casdo' => 'Accessibility Standards Canada',
                ...
                'ocsec' => 'Office of the Intelligence Commissioner',
                ...
                'wage' => 'Department for Women and Gender Equality',
