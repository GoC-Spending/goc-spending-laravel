...
class RunDepartment extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'department:run {acronym : The acronym of the department to scrape.}';
     ...
     * @var string
     */
    protected $description = 'Fetch and then parse the contract HTML for a department.';
