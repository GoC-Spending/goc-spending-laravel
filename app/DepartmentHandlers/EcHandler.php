...
class EcHandler extends DepartmentHandler
{
    ...
    public function fiscalYearFromQuarterPage($quarterHtml)
    {
        ...
        return Parsers::xpathRegexComboSearch($quarterHtml, "//div[@id='cn-centre-col-inner']//h1", '/([0-9]{4})/');
    }

    public function fiscalQuarterFromQuarterPage($quarterHtml)
    {

        return Parsers::xpathRegexComboSearch($quarterHtml, "//div[@id='cn-centre-col-inner']//h1", '/([0-9])</');
    }

    public function parseHtml($html)
    {

        return Parsers::extractContractDataViaGenericXpathParser($html, "//table//td[@scope='row']", "//table//td[@class='alignTopLeft']", ' to ');
    }
}
